...
public:
     ...
     * @since 1.2.0
     */
    virtual SignatureVerificationData& setData(const std::vector<uint8_t>& data, 
     ...
     *        not. If true, then the calypsonet::terminal::calypso::spi::SamRevocationServiceSpi
     ...
     * @since 1.2.0
     */
    virtual SignatureVerificationData& withSamTraceabilityMode(const int offset, 
     ...
     * @since 1.2.0
     */
    virtual SignatureVerificationData& useKeyDiversifier(const std::vector<uint8_t>& keyDiversifier)
        = 0;
